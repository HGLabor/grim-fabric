...
public final class SuperDebug extends Check implements PostPredictionCheck {
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        Location location = new Location(player.x, player.y, player.z, player.xRot, player.yRot, player.bukkitPlayer == null ? "null" : AntiCheatUtils.INSTANCE.getWorldName(player.bukkitPlayer.getWorld()));
        ...
        sb.append("\n");
        sb.append("ServerPlayerEntity Name: ");
