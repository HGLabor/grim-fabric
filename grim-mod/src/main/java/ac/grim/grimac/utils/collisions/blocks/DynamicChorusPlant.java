...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox fetch(GrimPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        ...
        // ServerPlayerEntity is 1.12- on 1.13 server
        // ServerPlayerEntity is 1.12 on 1.12 server
        ...
        if (PacketEvents.getAPI().getServerManager().getVersion().isNewerThanOrEquals(ServerVersion.V_1_13)) {
            // ServerPlayerEntity is 1.13 on 1.13 server
            ...
            // ServerPlayerEntity is 1.13 on 1.12 server
