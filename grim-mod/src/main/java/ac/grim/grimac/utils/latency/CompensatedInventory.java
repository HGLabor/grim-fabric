...
public class CompensatedInventory extends Check implements PacketCheck {
    ...
    // Special values:
    // ServerPlayerEntity inventory is -1
    ...
    public ItemStack getHeldItem() {
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getHeldItem() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getMainHandStack());
    ...
    public ItemStack getOffHand() {
        ...
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getOffhand() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getOffHandStack());
        return item == null ? ItemStack.EMPTY : item;
    }

    public ItemStack getHelmet() {
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getHelmet() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getEquippedStack(EquipmentSlot.HEAD));
        return item == null ? ItemStack.EMPTY : item;
    }

    public ItemStack getChestplate() {
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getChestplate() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getEquippedStack(EquipmentSlot.CHEST));
        return item == null ? ItemStack.EMPTY : item;
    }

    public ItemStack getLeggings() {
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getLeggings() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getEquippedStack(EquipmentSlot.LEGS));
        return item == null ? ItemStack.EMPTY : item;
    }

    public ItemStack getBoots() {
        ItemStack item = isPacketInventoryActive || player.bukkitPlayer == null ? inventory.getBoots() :
                SpigotConversionUtil.fromBukkitItemStack(player.bukkitPlayer.getEquippedStack(EquipmentSlot.FEET));
        return item == null ? ItemStack.EMPTY : item;
    }
    ...
    public boolean hasItemType(ItemType type) {
        ...
        for (DefaultedList<net.minecraft.item.ItemStack> itemStacks : player.bukkitPlayer.getInventory().combinedInventory) {
    ...
    public void onPacketSend(final PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.WINDOW_ITEMS) {
            ...
            if (items.getWindowId() == 0) { // ServerPlayerEntity inventory
                player.latencyUtils.addRealTimeTask(player.lastTransactionSent.get(), () -> {
        ...
        if (event.getPacketType() == PacketType.Play.Server.SET_SLOT) {
            ...
            player.latencyUtils.addRealTimeTask(player.lastTransactionSent.get(), () -> {
                ...
                } else if (slot.getWindowId() == 0) { // ServerPlayerEntity inventory
