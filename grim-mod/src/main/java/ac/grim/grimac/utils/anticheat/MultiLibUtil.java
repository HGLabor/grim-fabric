...
public class MultiLibUtil {
    ...
    public final static Method externalPlayerMethod = getMethod(ServerPlayerEntity.class, "isExternalPlayer");
    ...
    public static boolean isExternalPlayer(ServerPlayerEntity player) {
