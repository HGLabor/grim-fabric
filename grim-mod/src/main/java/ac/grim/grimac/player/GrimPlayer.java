...
import gg.norisk.verbrecher.utils.AntiCheatUtils;
...
public class GrimPlayer implements GrimUser {
    ...
    public int entityID;
    @Nullable
    public ServerPlayerEntity bukkitPlayer;
    ...
    public void disconnect(Component reason) {
        ...
        if (bukkitPlayer != null) {
            SchedulerUtils.INSTANCE.runLater(() -> {
                bukkitPlayer.networkHandler.disconnect(Text.of(textReason));
            }, 1);
        }
    }
    ...
    public void pollData() {
        ...
        if (uuid != null && this.bukkitPlayer == null) {
            this.bukkitPlayer = GrimAPI.getPlayer(uuid);
            updatePermissions();
        }
    }
    ...
    public void updatePermissions() {
        ...
        this.noModifyPacketPermission = LuckPermsUtils.INSTANCE.hasPermission(bukkitPlayer, "grim.nomodifypacket");
        this.noSetbackPermission = LuckPermsUtils.INSTANCE.hasPermission(bukkitPlayer, "grim.nosetback");
        SchedulerUtils.INSTANCE.async(() -> {
    ...
    public @Nullable String getWorldName() {
        return bukkitPlayer != null ? AntiCheatUtils.INSTANCE.getWorldName(bukkitPlayer.getWorld()) : null;
    }
    ...
    @Getter
    private boolean mitigateAutoblock;
    @Getter
    private boolean mitigateDesyncNoSlow;
    ...
    public void sendMessage(String message) {
        if (bukkitPlayer != null) bukkitPlayer.sendMessage(Text.of(message));
    }
